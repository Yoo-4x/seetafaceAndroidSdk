...
include $(CLEAR_VARS)
LOCAL_MODULE := pe-prebuilt
LOCAL_SRC_FILES := ${LOCAL_PATH}/../../PoseEstimator6/PoseEstimation/android/libs/$(TARGET_ARCH_ABI)/libSeetaPoseEstimation600.so
...
MY_CPP_LIST += $(wildcard $(LOCAL_PATH)/src/seeta/plugin/*.cpp)
...
LOCAL_SHARED_LIBRARIES += pe-prebuilt
